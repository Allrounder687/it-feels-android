  ...
  Widget _buildApiKeyField({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: context.themeTextColor.withOpacity(0.04),
  ...
  Widget _buildRadioTile(BuildContext context, {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? context.themeAccentColor.withOpacity(0.12) : context.themeTextColor.withOpacity(0.04),
          borderRadius: BorderRadius.circular(14),
          border: selected ? Border.all(color: context.themeAccentColor.withOpacity(0.5), width: 1) : null,
        ),
        child: Row(
          children: [
            Icon(
