...
class _FullscreenVideoScreenState extends State<FullscreenVideoScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer4<AudioPlayerProvider, DownloadProvider, VideoPlayerProvider, SettingsProvider>(
      builder: (context, audioProvider, downloadProvider, videoProvider, settingsProvider, child) {
