...
class VideoPlayerProvider extends ChangeNotifier {
  ...
  Future<void> _initializeStreamForQuality(String targetQuality, {Duration? startPosition}) async {
    ...
    // Route streams through local proxy to strip ExoPlayer's metadata headers and spoof a clean mobile request
    ...
    videoController = VideoPlayerController.networkUrl(
      ...
      videoPlayerOptions: VideoPlayerOptions(mixWithOthers: true),
      // We pass headers to ExoPlayer too, but proxy will ultimately strip the identifying ones
      httpHeaders: {
